 ...
 */
final class Version20231215044416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE kitchen (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, main_image VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, message1 VARCHAR(100) DEFAULT NULL, message2 VARCHAR(100) DEFAULT NULL, message3 VARCHAR(100) DEFAULT NULL, image1 VARCHAR(100) NOT NULL, image2 VARCHAR(100) DEFAULT NULL, image3 LONGTEXT DEFAULT NULL, image4 VARCHAR(100) DEFAULT NULL, image5 LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
