 ...
 */
final class Version20240930050759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, caracteristique_1 VARCHAR(255) DEFAULT NULL, caracteristique_2 VARCHAR(255) DEFAULT NULL, caracteristique_3 VARCHAR(255) DEFAULT NULL, caracteristique_4 VARCHAR(255) DEFAULT NULL, image VARCHAR(200) NOT NULL, pdf_name VARCHAR(255) DEFAULT NULL, pdf_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
